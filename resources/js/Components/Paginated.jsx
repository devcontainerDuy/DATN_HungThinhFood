    ...
    return (
        <>
            <Pagination className="justify-content-center mt-2">
                ...
                {current > 3 && (
                    <>
                        <Pagination.Item linkClassName="text-danger" onClick={() => handle(1)}>
                            1
                        </Pagination.Item>
                ...
                {current > 1 && (
                    <Pagination.Item linkClassName="text-danger" onClick={() => handle(current - 1)}>
                        {current - 1}
                    </Pagination.Item>
                )}
                ...
                {current < total - 2 && (
                    <>
                        <Pagination.Ellipsis linkClassName="text-danger" />
                        <Pagination.Item linkClassName="text-danger" onClick={() => handle(total)}>
                            {total}
                        </Pagination.Item>
                    </>
                )}
